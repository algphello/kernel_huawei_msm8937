...
static enum Tfa98xx_Error tfa9872_specific(struct tfa_device *tfa)
{
	...
	reg_write(tfa, 0x48, 0x0000); //disable all interruption
	reg_write(tfa, 0x49, 0x0000); //disable all interruption
	reg_write(tfa, 0x4A, 0x0000); //disable all interruption
